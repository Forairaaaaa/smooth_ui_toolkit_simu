/**
 * @file app_transition_simple_test.cpp
 * @author Forairaaaaa
 * @brief
 * @version 0.1
 * @date 2024-06-21
 ...
 *
 */
#include "app_transition_simple_test.h"
#include "../../hal/hal.h"
...
void AppTransitionSimpleTest::onResume() { spdlog::info("{} onResume", getAppName()); }

void AppTransitionSimpleTest::onRunning()
{
    // transition_simple_test();
    transition_user_data_test();
}

void AppTransitionSimpleTest::onDestroy() { spdlog::info("{} onDestroy", getAppName()); }
