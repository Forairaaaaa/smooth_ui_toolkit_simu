 ...
 * 
 */
class SelectMenuRenderCb_RawApiTest : public SmoothUIToolKit::SimpleMenuCallback_t
{
public:
    void renderCallback(
...
{
    // Create a menu 
    SmoothUIToolKit::Simple_Menu simple_menu(HAL::GetCanvas()->width(), HAL::GetCanvas()->height());
